    ...
    public static class DSU { // Disjoint Set Union Class
        ...
        public DSU(int n) {
            ...
            for (int i = 0; i < parent.length; i++)
                parent[i] = i; // Set the parent array values as the index (in start each node is itself a
                               // component)
        }
        ...
        public boolean union(int x, int y) {
            ...
            if (rootX == rootY)
                return false;
            else { // Apply path compression to add smaller component into the larger component
                   // based on their ranks and update their parents
